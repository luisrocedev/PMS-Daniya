...
try {
     ...
     *    Parámetros opcionales: search (filtra en "descripcion"), estado, page, limit
    ...
    if ($method === 'GET') {
        ...
        echo json_encode($ok
            ? ['success' => true, 'msg' => 'Incidencia creada']
        ...
        echo json_encode($ok
            ? ['success' => true, 'msg' => 'Incidencia eliminada']
    ...
    // Limpiar cualquier salida previa y devolver error en JSON
    if (ob_get_length()) {
        ob_clean();
    }
